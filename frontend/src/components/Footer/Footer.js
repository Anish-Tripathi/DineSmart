        ...
        <div className={styles.row}>
          <div className={styles.colLg3}>
            ...
            <p className={styles.footerDescription}>
              Welcome to DineSmart, your go-to spot for delicious meals
              delivered straight to you. Explore our menu of mouthwatering
              dishes, carefully crafted to satisfy every craving. Order now and
              enjoy a seamless dining experience at the comfort of your home.
            </p>
